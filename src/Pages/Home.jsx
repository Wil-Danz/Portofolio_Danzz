...
const WORDS = ["Network & Telecom Student", "Tech Enthusiast", "Artificial Inteligence"];
const TECH_STACK = ["WordPress", "PHP", "HTML", "Tailwind", "Kali Linux"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Wil-Danz" },
  { icon: YouTube, link: "https://www.youtube.com/@wildan.farhany.r5829" },
  { icon: Instagram, link: "https://www.instagram.com/danzz_123345678910?igsh=MjF3d2dzNG81amU4" }
];
